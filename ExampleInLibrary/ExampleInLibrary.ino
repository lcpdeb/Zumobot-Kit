...
const uint16_t lineSensorThreshold = 500;//1000

// The speed that the robot uses when backing up.
const uint16_t reverseSpeed = 100;//200

// The speed that the robot uses when turning.
const uint16_t turnSpeed = 100;//200
...
const uint16_t forwardSpeed = 150;//200
...
const uint16_t veerSpeedHigh = 100;//250
...
const uint16_t rammingSpeed = 100;//400
